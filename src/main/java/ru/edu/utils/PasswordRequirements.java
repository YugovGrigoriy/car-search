...
public class PasswordRequirements {
    public static void main(String[] args) {
        ...
        System.out.println(passwordRequirements(pass,name));
    }
// пароль: от 8 символов, не содержит username, не содержит последовательности, минимум 1 заглавная, 1 строчная и 1 цифра
    public static boolean passwordRequirements(String password, String username) {
        ...
        return !password.matches(".*" + username + ".*") && !password.matches(".*" + new StringBuilder(username).reverse() + ".*");
    }
}
